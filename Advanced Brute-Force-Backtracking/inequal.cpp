/*
문제
두 종류의 부등호 기호 ‘<’와 ‘>’가 k 개 나열된 순서열 A가 있다. 우리는 이 부등호 기호 앞뒤에 서로 다른 한 자릿수 숫자를 넣어서 
...
int m1[10] = {0}; //최대
int m2[10] = {9,9,9,9,9,9,9,9,9,9}; //최소
int order[10] = {0};
int n;

void inequaltracking(int depth, int cur);
int main()
{
    cin >> n;
